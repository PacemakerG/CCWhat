...
class OpenSpecGraphViewerTests(unittest.TestCase):
    def test_diagnostics_page_mounts_the_react_graph_island(self) -> None:
        ...
        self.assertIn('href="/static/graph-diagnosis/graph-diagnosis.css?v=minimap-window-1"', html)
        self.assertIn('src="/static/graph-diagnosis/graph-diagnosis.js?v=minimap-window-1"', html)
